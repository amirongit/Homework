...
urlpatterns = [
    path('teacher/', include(
          [
           ...
           path('update_grade/<int:pk>/', views.UpdateGradeView.as_view(),
                name='update_grade'),
           path('attendancy_details/<int:pk>/',
                views.AttendancyDetailsView.as_view(),
                name='attendancy_details'),
           path('new_lecture/<int:presentation_id>/',
                views.NewLectureView.as_view(),
                name='new_lecture')
          ]
               )),
    path('student/', include(
          [
           ...
           path('submit_answer/<int:homework_id>/',
                ...
                name='submit_answer'),
           path('courses/', views.StudentCoursesView.as_view(),
